    ...
    return Drawer(
      ...
      child: Column(
        ...
        children: [
          ...
          SansBold("Beno Dev", 25.0),
          SizedBox(height: 15.0),
          IconLauncher(assets: "assets/instagram.svg", url: "https://www.instagram.com/x", text: "ig", size: 20.0),
          SizedBox(height: 15.0),
          IconLauncher(assets: "assets/twitter.svg", url: "https://www.twitter.com/x", text: "tw", size: 20.0),
          SizedBox(height: 15.0),
          IconLauncher(assets: "assets/github.svg", url: "https://www.github.com/x", text: "gh", size: 20.0),
        ],
      ),
    );
  }
        ...
        children: [
          ...
          ConstrainedBox(
            ...
            child: Row(
              ...
              children: [
                IconLauncherOnly(assets: "assets/instagram.svg", url: "https://www.instagram.com/x", size: 30.0),
                IconLauncherOnly(assets: "assets/twitter.svg", url: "https://www.twitter.com/x", size: 30.0),
                IconLauncherOnly(assets: "assets/github.svg", url: "https://www.github.com/x", size: 30.0),
              ],
            ),
          )
        ],
